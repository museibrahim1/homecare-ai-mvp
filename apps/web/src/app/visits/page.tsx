      ...
      <main className="flex-1 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="text-3xl font-bold text-dark-50 mb-2">Assessments</h1>
              <p className="text-dark-400">Review and manage care assessments</p>
            </div>
            <div className="flex gap-3">
              ...
              {!isAdmin && visits.length > 0 && (
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-dark-900 hover:bg-red-50 text-dark-300 hover:text-red-600 rounded-xl font-medium transition-colors"
                >
                  <Trash2 className="w-5 h-5" />
                  Clear All
                </button>
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="card p-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-200">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-dark-50 mb-2">Try a Sample Assessment</h3>
              ...
              <div className="card p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-dark-50 mb-2">No assessments yet</h3>
