          ...
          <div className="ma-hero-text">
            ...
            <div className="ma-hero-btns">
              <a
                ...
                className="ma-appstore-btn"
                onClick={() => trackAppStoreClick('mobile_app_hero')}
              >
          ...
          <div className="ma-why-text">
            ...
            <div className="ma-why-btns">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="ma-demo-btn"
                onClick={() => trackAppStoreClick('mobile_app_mid')}
              >
        ...
        <div className="ma-download-inner">
          ...
          <div className="ma-download-btns">
            <a
              ...
              rel="noopener noreferrer"
              className="ma-appstore-btn"
              onClick={() => trackAppStoreClick('mobile_app_footer')}
            >
