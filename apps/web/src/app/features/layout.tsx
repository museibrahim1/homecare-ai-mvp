...
export const metadata: Metadata = {
  title: 'Features: AI Home Care Documentation and CRM',
  description:
  ...
  openGraph: {
    ...
    description:
      'Voice-powered assessments, AI contract generation, client CRM, caregiver scheduling, and billing analytics in one platform built for home care.',
