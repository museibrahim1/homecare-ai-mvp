        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <a href="/register" className="px-3 py-2 text-dark-300 hover:text-white transition">Sign Up Free</a>
            </div>

            <div className="hidden lg:flex items-center gap-3">
              <Link href="/login" className="text-dark-300 hover:text-white transition px-3 py-2">Sign In</Link>
              <a href="/register" className="btn-primary py-2 px-5 text-sm">Sign Up Free</a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden pt-4 pb-2 space-y-3 border-t border-dark-700 mt-4">
              ...
              <a href="/register" onClick={() => setMobileMenuOpen(false)} className="block py-2 text-dark-300 hover:text-white">Sign Up Free</a>
              ...
              <a href="/register" onClick={() => setMobileMenuOpen(false)} className="block btn-primary py-2 px-5 text-sm text-center mt-4">Sign Up Free</a>
            </div>
          )}
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-dark-400 text-sm">
                ...
                <li><a href="/register" className="hover:text-white transition">Sign Up Free</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-dark-400 text-sm">
                ...
                <li><a href="/register" className="hover:text-white transition">Free Trial</a></li>
              </ul>
            </div>
            <div>
