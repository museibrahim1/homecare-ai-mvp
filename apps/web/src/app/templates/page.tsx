...
const SECTION_COLORS: Record<string, string> = {
  ...
  unknown: 'text-dark-400 bg-dark-700 border-dark-700',
};
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-dark-50">Contract Templates</h1>
          ...
          <div className="flex gap-1 mb-6 bg-dark-800 border border-dark-700 rounded-xl p-1">
            ...
            >
              ...
              My Templates
              {templates.length > 0 && (
                <span className="px-1.5 py-0.5 bg-dark-900 text-dark-300 text-xs rounded-full">{templates.length}</span>
              )}
            </button>
            <button
            ...
            >
              ...
              Template Gallery
              {gallery.length > 0 && (
                <span className="px-1.5 py-0.5 bg-dark-900 text-dark-300 text-xs rounded-full">{gallery.length}</span>
              )}
            </button>
          </div>
            ...
            <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
              <div className="bg-dark-800 border border-dark-700 rounded-2xl w-full max-w-lg p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={() => setShowUpload(false)} className="text-dark-400 hover:text-dark-50">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="w-full p-6 border-2 border-dashed border-dark-700 rounded-xl hover:border-primary-500/50 transition text-center"
                    >
                      {uploadFile ? (
                        <div className="flex items-center gap-3 justify-center">
                          <FileText className="w-6 h-6 text-primary-400" />
                          <div className="text-left">
                            <p className="text-dark-50 font-medium">{uploadFile.name}</p>
                        ...
                        <div>
                          ...
                          <p className="text-dark-400 text-xs mt-1">Max 20MB — OCR will extract all fields</p>
                        </div>
                      )}
                    </button>
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 px-4 py-2.5 border border-dark-700 text-dark-300 rounded-lg hover:text-dark-50 transition"
                    >
                      Cancel
                    </button>
                    <button
            ...
            <>
              {loading ? (
                ...
                <div className="text-center py-16 bg-dark-800 border border-dark-700 rounded-2xl">
                  ...
                  <h3 className="text-xl font-semibold text-dark-50 mb-2">No Templates Yet</h3>
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <button
                      onClick={() => setActiveTab('gallery')}
                      className="inline-flex items-center gap-2 px-5 py-2.5 border border-dark-700 text-dark-300 hover:text-dark-50 hover:border-dark-600 rounded-lg transition font-medium"
                    >
                      <BookOpen className="w-4 h-4" />
                      Browse Gallery
                    </button>
                ...
                <div className="space-y-4">
                  {templates.map((tmpl) => {
                    ...
                    return (
                      <div key={tmpl.id} className="bg-dark-800 border border-dark-700 rounded-xl overflow-hidden">
                        {/* Template Header */}
                        <button
                          onClick={() => {
                            if (isExpanded) {
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <h3 className="text-dark-50 font-semibold truncate">{tmpl.name}</h3>
                              <span className="px-2 py-0.5 bg-dark-900 text-dark-400 text-xs rounded-full shrink-0">
                                v{tmpl.version}
                              </span>
                              {tmpl.is_active && (
                            ...
                            <div className="flex items-center gap-4 mt-1">
                              ...
                              <span className="text-dark-400 text-xs">{fieldCount} fields</span>
                              {unmappedCount > 0 && (
                        ...
                        {isExpanded && detail && (
                          <div className="border-t border-dark-700">
                            {/* Actions */}
                            <div className="p-4 flex items-center gap-2 border-b border-dark-700 bg-dark-800">
                              <button
                                onClick={() => handleRescan(tmpl.id)}
                                disabled={rescanning === tmpl.id}
                                className="flex items-center gap-2 px-3 py-1.5 bg-dark-900 hover:bg-dark-700/50 text-dark-300 hover:text-dark-50 rounded-lg text-sm transition"
                              >
                              ...
                              <button
                                ...
                                className="flex items-center gap-2 px-3 py-1.5 bg-dark-900 hover:bg-red-50 text-dark-300 hover:text-red-600 rounded-lg text-sm transition"
                              >
                              ...
                              <div className="m-4 p-4 bg-amber-50 border border-amber-500/20 rounded-xl">
                                ...
                                <div className="space-y-2">
                                  {detail.unmapped_fields.map((field) => (
                                    <div key={field.field_id} className="flex items-center gap-3 bg-dark-800 rounded-lg p-3">
                                      <div className="flex-1">
                                        <span className="text-dark-50 text-sm font-medium">{field.label || field.field_id}</span>
                                        <div className="flex items-center gap-2 mt-0.5">
                                          ...
                                          <span className="text-dark-400 text-xs">{field.type}</span>
                                        </div>
                                      </div>
                                      {mappingField === field.field_id ? (
                                        <div className="flex items-center gap-2">
                                          <select
                                            ...
                                            className="px-2 py-1 bg-dark-900 border border-dark-700 rounded text-dark-50 text-xs focus:border-primary-500 focus:outline-none"
                                          >
                                          ...
                                          <button onClick={() => { setMappingField(null); setMappingTarget(''); }} className="p-1 text-dark-400 hover:text-dark-50">
                                            <X className="w-4 h-4" />
                                          </button>
                                        </div>
                                      ) : (
                            ...
                            <div className="p-4">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                {detail.detected_fields.map((field, idx) => {
                                  ...
                                  return (
                                    <div key={idx} className={`flex items-center gap-3 p-3 rounded-lg border ${isMapped ? 'bg-green-500/5 border-green-500/20' : 'bg-dark-900/30 border-dark-700/30'}`}>
                                      <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${isMapped ? 'bg-emerald-50' : 'bg-dark-700/50'}`}>
                                        {isMapped ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Unlink className="w-3.5 h-3.5 text-dark-400" />}
                                      </div>
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                          <span className="text-dark-50 text-sm truncate">{field.label || field.field_id}</span>
                                      ...
                                      <span className="text-dark-400 text-xs shrink-0">{field.type}</span>
                                    </div>
                                  );
                                })}
                              </div>
                            ...
                            <div className="p-4 border-t border-dark-700 bg-dark-800">
                              <div className="grid grid-cols-3 gap-4">
                                <div className="text-center">
                                  <p className="text-2xl font-bold text-dark-50">{detail.detected_fields.length}</p>
                                ...
                                <div className="text-center">
                                  <p className={`text-2xl font-bold ${detail.unmapped_fields.length > 0 ? 'text-amber-600' : 'text-dark-400'}`}>{detail.unmapped_fields.length}</p>
            ...
            <>
              ...
              {galleryLoading ? (
                ...
                <div className="text-center py-16 bg-dark-800 border border-dark-700 rounded-2xl">
                  ...
                  <h3 className="text-xl font-semibold text-dark-50 mb-2">No Gallery Templates</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {gallery.map((item) => {
                    ...
                    return (
                      <div key={item.slug} className="bg-dark-800 border border-dark-700 rounded-xl p-5 flex flex-col">
                        <div className="flex items-start gap-3 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-dark-50 font-semibold">{item.name}</h3>
