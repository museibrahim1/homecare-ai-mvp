...
export default function WhatsNewModal({ release, onClose }: WhatsNewModalProps) {
  ...
  // Corner toast, not a modal: never cover the app with an invisible
  // full-screen hit target. That blocked the CRM nav (and every other
  // control) while the "Agency CRM" announcement was open.
  return (
    <div
      role="dialog"
      aria-modal="false"
