...
const defaultConfig = { gradient: 'from-dark-500 to-dark-400', bg: 'bg-dark-900', text: 'text-dark-300' };
  ...
  if (segments.length === 0) {
    return (
      <div className="p-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-dark-50 mb-2">No transcript available</h3>
            ...
            <div
              ...
              className={`group p-4 rounded-xl border transition-all duration-300 cursor-pointer ${
                isActive 
                  ...
                  : 'bg-dark-900/30 border-dark-700 hover:bg-dark-700/50 hover:border-dark-600'
              }`}
            >
        ...
        {visibleCount < segments.length && (
          <div className="text-center pt-4">
            <button
              ...
              className="px-4 py-2 bg-dark-900 hover:bg-dark-700/50 text-dark-300 hover:text-dark-50 rounded-lg text-sm transition"
            >
