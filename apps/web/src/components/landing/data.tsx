    ...
    features: [
      {
        ...
        image: '/screenshots/glass/paper-pipeline-recording.png',
      },
      {
        icon: Brain,
        ...
        image: '/screenshots/glass/paper-pipeline-contract.png',
      },
      {
        icon: Zap,
        ...
        image: '/screenshots/glass/paper-pipeline-billables.png',
      },
      {
        icon: FileText,
        title: 'Review & Sign',
        ...
        image: '/screenshots/glass/paper-pipeline-notes.png',
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        image: '/screenshots/glass/paper-web-clients.png',
      },
      {
        icon: ClipboardList,
        title: 'Documents',
        ...
        color: 'from-teal-500 to-cyan-500',
        image: '/screenshots/glass/paper-web-documents.png',
      },
      {
        icon: Calendar,
        ...
        image: '/screenshots/glass/paper-web-visit.png',
      },
      {
        icon: Settings,
        title: 'Dashboard',
        ...
        image: '/screenshots/glass/paper-web-home.png',
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        image: '/screenshots/glass/paper-web-billing.png',
      },
      {
        icon: TrendingUp,
        title: 'Care Plan',
        description: 'Care plan generated from the visit, ready for review before the contract.',
        color: 'from-cyan-500 to-blue-500',
        image: '/screenshots/glass/paper-pipeline-care-plan.png',
      },
      {
        icon: Shield,
        title: 'Client Detail',
        description: 'History, documents, and visit status on one client profile.',
        color: 'from-amber-500 to-orange-500',
        image: '/screenshots/glass/paper-web-client-detail.png',
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        image: '/screenshots/glass/paper-app-home.png',
      },
      {
        icon: HeartPulse,
        title: 'Care Profiles',
        ...
        image: '/screenshots/glass/paper-app-client-detail.png',
      },
      {
        icon: Globe,
        title: 'Clients',
        description: 'Your full client list on phone, with status and next visit at a glance.',
        color: 'from-blue-500 to-sky-500',
        image: '/screenshots/glass/paper-app-clients.png',
      },
      {
        icon: Headphones,
        ...
        image: '/screenshots/glass/paper-pipeline-palm-it.png',
      },
    ],
  },
];
