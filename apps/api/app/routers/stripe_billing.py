...
STRIPE_SUCCESS_URL = os.getenv("STRIPE_SUCCESS_URL", "https://app.homecare.ai/billing/success")
STRIPE_CANCEL_URL = os.getenv("STRIPE_CANCEL_URL", "https://app.homecare.ai/pricing")
