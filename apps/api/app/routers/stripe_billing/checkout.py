...
async def create_checkout_session(
    ...
    try:
        ...
        if existing_sub and existing_sub.stripe_customer_id and existing_sub.stripe_customer_id.startswith("apple:"):
        ...
        customer_id = None
        if existing_sub and existing_sub.stripe_customer_id and not existing_sub.stripe_customer_id.startswith("apple:"):
