"""Curated seed investor dataset, extracted from the original investors.py.

This is a large static data function used by the POST /seed-data endpoint.
Isolated here so the route logic stays readable.
"""
