# PALM Monthly Content Calendar (Jul 13 to Aug 9, 2026)

> **v4, the polished rebuild.** Every creative below is designed in-house from PALM's real
> brand assets: the actual hand logo, the actual app screenshots, the site typeface (Inter),
> and the app's teal. No AI-generated images, no invented logos, no stock-photo look, and
> no AI-slop punctuation (no em-dashes, no throwaway slashes).
>
> Built with the creative studio at `marketing/creative-studio/` (HTML and CSS templates
> rendered to pixel-perfect PNG). Any card can be edited and re-rendered in seconds:
> `node marketing/creative-studio/render.js`
>
> Formats follow current platform data: 4:5 (1080x1350) images for Meta feed,
> a 7-page 1200x1200 PDF document carousel for LinkedIn (the highest-engagement
> LinkedIn format in 2026, about 7% average engagement versus 3.25% for link posts).
>
> **LinkedIn rule (2026): keep the post body link-free and value-dense.** LinkedIn now
> throttles reach for external links in the body, and increasingly for first-comment links
> too. Our approach: full value in the post, the signup link in the first comment as a
> low-key CTA, and the URL kept off the image itself. Meta captions carry the link directly;
> IG uses link in bio.
>
> Cadence: Meta (FB and IG) Mon, Wed, Fri. LinkedIn Tue, Thu. 20 posts total.
...
| # | File | Style | Angle |
|---|---|---|---|
| 1 | `w1-imsg-contract.png` | iMessage thread | "already sent it," the same-day contract |
...
| 4 | `w1-timeline-sameday.png` | Timeline 10:00 to 12:15 | Signed before the competition calls back |
...
| 13 | `w4-pov-home.png` | POV plus real notification | POV: the visit ended two minutes ago |
| 14 | `w3-math.png` | Big-numbers math | 312 hours a year is 39 working days |
| 15 | `w4-states.png` | Typographic "50" | 50 rule books. One draft that follows yours. |
| 16 | `w4-sunday-split.png` | Before and after split | Sunday 9:14 PM, with and without PALM |
...
| B | `w1-checklist.png` | Checklist (bonus) | IG Story asset, the after-visit to-do list |
...
### Wed Jul 15, Meta (FB and IG), #3 Record screen
...
### Fri Jul 17, Meta (FB and IG), #5 Receipt
...
## WEEK 2 (Jul 20 to Jul 26)

### Mon Jul 20, Meta (FB and IG), #6 Notification stack
...
### Wed Jul 22, Meta (FB and IG), #8 Contract screen
...
### Fri Jul 24, Meta (FB and IG), #10 Sticky note
> Note to self 📝
>
...
## WEEK 3 (Jul 27 to Aug 2)

### Mon Jul 27, Meta (FB and IG), #11 Fill in the blank
> Finish the sentence 👇
>
...
### Wed Jul 29, Meta (FB and IG), #13 POV
...
### Fri Jul 31, Meta (FB and IG), #15 50 states
...
## WEEK 4 (Aug 3 to Aug 9)

### Mon Aug 3, Meta (FB and IG), #16 Sunday split
...
### Wed Aug 5, Meta (FB and IG), #18 Billables screen
...
### Fri Aug 7, Meta (FB and IG), #20 Poll results
...
## Bonus asset
- `w1-checklist.png`, the "Everything below is PALM's job now" checklist. Use as an IG Story
  with a poll sticker ("Which of these do you still do by hand?") any week.

## Posting notes
- Meta: post 11am to 1pm local; caption link is fine on FB, IG link in bio.
- LinkedIn: Tue and Thu window, keep the body link-free, put the signup link in the first
  comment, and upload the PDF carousel as a "document."
- All images: 1080x1350 (4:5) for Meta feed; carousel pages 1200x1200 PDF.
- Regenerate or edit any card: edit `marketing/creative-studio/cards/*.html`, then
  `node marketing/creative-studio/render.js`.
