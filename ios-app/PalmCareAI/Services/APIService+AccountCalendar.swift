...
extension APIService {
    ...
    /// Password accounts must re-enter password; social-only accounts confirm email.
    func deleteAccount(password: String? = nil, emailConfirm: String? = nil) async throws {
        var body: [String: Any] = [
        ...
        if let emailConfirm, !emailConfirm.isEmpty {
