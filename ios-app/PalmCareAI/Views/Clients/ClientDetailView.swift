...
struct ClientDetailView: View {
    ...
    private func medicalNotesView(_ rawNotes: String) -> some View {
    ...
    private struct AssessmentBlock {
        let date: String?
        let sections: [(title: String, content: String)]
    }

    private func parseAssessments(_ raw: String) -> [AssessmentBlock] {
    ...
    private var visitsErrorView: some View {
        VStack(spacing: 16) {
